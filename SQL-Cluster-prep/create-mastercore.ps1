...
#Deploy MASTER2022CORE
$imagePath = "C:\Temp\SERVER_EVAL_x64FRE_en-us.iso"
$vhdPath = (Get-VMHost).VirtualHardDiskPath
$newVHD = New-VHD -SizeBytes 70GB -Dynamic -Path ($vhdPath+"\MASTER2022CORE-sys.vhdx")
$newVM = New-VM -Name "MASTER2022CORE" -MemoryStartupBytes 4000MB -Generation 2 -VHDPath $newVHD.Path -BootDevice VHD 
